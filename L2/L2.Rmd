...
![Change directory on MAC!](/Users/alendzidic/Documents/PROJECTS/Setting_working_directory_on_MAC_1.png)

![Change directory on MAC !](/Users/alendzidic/Documents/PROJECTS/Setting_working_directory_on_MAC_2.png)
...
![Create R Markdown document on MAC !](/Users/alendzidic/Documents/PROJECTS/Open_R_Markdown _document.png)
...
![Run R code chunk in R Markdown document on MAC !](/Users/alendzidic/Documents/PROJECTS/L_2_R_Markdown.jpg)


If we want to execute comans line by line we would point to the line of code within R code chunk and in Windows press CTRL + R, and on Mac CMD + ENTER.
...
Boxplot represents centrality, spread and skewnees of the distribution and defines an outlier if that observation lies more than 1.5 times the interquartile range below the lower or above the upper quartile.

![Boxplot!](/Users/alendzidic/Documents/PROJECTS/R_lectures/L2/boxplot.jpg)
...
abline (a=0,b=1) # draws a symetric line
```

## Histrograms

They explore distribution of the contionous variable.
It is always good to explore with the bins to get a more complete undestanding of the distribution.
...
**IMPORTANT: As seen in the Second R Markdown script file it is important to make comments with # sign in the R code chunk. It is even important for yourself, while you cannot e-mail to yourself in the past! (Qoute: Hadley Wickham)**

#Assignment 1

1. Measure your left and right fingers 
2. Create two variables:
left.yourfirstname <- (Thumb, Index finger, Middle finger, Ring finger and Little finger)
right.yourfirstname <- (Thumb, Index finger, Middle finger, Ring finger and Little finger)
