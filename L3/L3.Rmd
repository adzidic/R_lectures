...
*Remember that name of the variable finger length should be written either as finger.length or finger_lenght, but not "finger length" as R will add in "." in place of the white spaces on your behalf.*
...
What is your conclusion about how the different treatment applications affect growth?
