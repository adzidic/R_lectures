...
### Basic graphics / plots in R
  ...
  2. Scatter plots (including how to make pretty graphs): 
      a. [podcast 1 - graphics in base R](https://youtu.be/QMu5riQ1rd8), Rmarkdown L
      b. [podcast 2 - graphics in ggplot]()
